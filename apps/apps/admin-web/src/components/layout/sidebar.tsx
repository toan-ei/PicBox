          ...
          <nav className="flex-1 overflow-y-auto overflow-x-hidden py-5 px-2.5">
            {navGroups.map((group, gi) => (
              <div key={group.label} className={gi > 0 ? "mt-7" : ""}>
                {/* Group label */}
                {!collapsed ? (
                  <p className="mb-2 px-3 text-[10px] font-bold uppercase tracking-[0.14em] text-slate-600 select-none">
                    {group.label}
                  </p>
                ) : (
                  <div
            ...
            {collapsed ? (
              ...
              <div className="flex flex-col items-center gap-2">
                <Tooltip label="Admin · Super Admin">
                  <div
                    className="h-9 w-9 rounded-xl flex items-center justify-center text-xs font-bold text-white cursor-pointer"
                    style={{
              ...
              >
                ...
                {/* Logout button */}
                <button
                  className="w-full flex items-center justify-center gap-2 h-8 rounded-lg text-[12px] font-medium transition-all duration-200 cursor-pointer"
                  style={{
                    background: "rgba(239,68,68,0.07)",
